...
<%
	...
	{
		response.sendRedirect("/logoutAdmin");
	}
%>
    <!-- Topbar Start -->
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="/logoutAdmin" class="nav-item nav-link">Logout</a>
                    </div>
                </div>
            </nav>
        </div>
      ...
      <div class="container">
        ...
        <form action="/saveappointment" method="post" role="form" class="php-email-form">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
               <input type="text" name="symptoms" class="form-control" id="symptoms" placeholder="Symptoms" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group mt-3">
          ...
          <br>
          <div class="text-center" ><a href="adminHome.jsp">Back to Home</a></div>
        </form>
