					...
					<form action="/loginCheckPatient" method="post">
						...
						<div class="form-outline mb-4">
							<label class="form-label" for="form3Example3">USER ID</label> <input
								...
								class="form-control form-control-lg" placeholder="User ID" name="patientEmail" />
						...
						<div class="d-flex justify-content-between align-items-center">
							...
							<a href="/forgotPassword1" class="text-body">Forgot password?</a>
						</div>
						...
						<div class="text-center text-lg-start mt-4 pt-2">
							...
							<p class="small fw-bold mt-2 pt-1 mb-0">
								Don't have an account? <a href="/userreg" class="link-danger">Register</a>
							</p>
						</div>
