                ...
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <div>
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="/loginCheckDoctor" class="dropdown-item">Login</a>
                                </div>
                                </div>
                                <br>
                                <div class="nav-item dropdown">
                            <a href="#" class="btn btn-outline-light rounded-pill py-md-3 px-md-5 mx-2" data-bs-toggle="dropdown">Patient Registration/Login</a>
                            <div class="dropdown-menu m-0">
                                <a href="/userreg" class="dropdown-item">Registration</a>
                                <a href="/userlogin" class="dropdown-item">Login</a>
                                </div>
                                </div>
