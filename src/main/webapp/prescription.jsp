                ...
                <div class="table-responsive">
                  <table class="table table-borderless mb-0">
                    ...
                    <tbody>
                     ...
                     <% ArrayList<Appointment> appointmentList = (ArrayList) request.getAttribute("appointmentDetails");
              		if(request.getAttribute("appointmentDetails") !=null)
              		{
              			Iterator<Appointment> appointmentIterator =  appointmentList.iterator();
              			while(appointmentIterator.hasNext())
              			{
              				Appointment appointmentDetails1 = appointmentIterator.next();
                 ...
                 %>
                      <tr>
                        ...
                        <td><%= i=i+1 %></td>
                        <td> <%= appointmentDetails1.getPatientId()  %></td>
                        <td><%= appointmentDetails1.getPatientName() %></td>
                        <td><%= appointmentDetails1.getSymptoms() %></td>
                        <td><%= appointmentDetails1.getDate() %></td>
                       <td> <%= appointmentDetails1.getPrescription() %>" </a></td>
                        <td>
