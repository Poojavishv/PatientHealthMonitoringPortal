...
<!-- ======= Appointment Section ======= -->
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form action="/UpdateDiet" method="post" role="form" class="php-email-form">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-4 form-group mt-3">
              <input type="datetime-local" name="timeOfIntake" class="form-control datepicker" id="timeOfIntake" value="${dietDetails.getTimeOfIntake() }" placeholder="Appointment Date" readonly>
              <div class="validate"></div>
            </div>
