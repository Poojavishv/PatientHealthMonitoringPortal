    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>View Update Patient Record  Details</h2>
          </div>
                ...
                <div class="table-responsive">
                  <table class="table table-borderless mb-0">
                    ...
                    <tbody>
                     ...
                     <% ArrayList<PatientRecords> PatientRecordsList = (ArrayList) request.getAttribute("patientRecordsDetails");
              		if(request.getAttribute("patientRecordsDetails") !=null)
              		{
              			Iterator<PatientRecords> patientRecordsIterator =  PatientRecordsList.iterator();
              			while(patientRecordsIterator.hasNext())
              			{
              				PatientRecords PatientRecords1 = patientRecordsIterator.next();
                 ...
                 %>
                      <tr>
                        ...
                        <td><%= i=i+1 %></td>
                        <td> <%= PatientRecords1.getPatientId()  %></td>
                        <td><%= PatientRecords1.getBmi() %></td>
                        <td><%= PatientRecords1.getGlucoseLevel() %></td>
                        <td><%= PatientRecords1.getCalories() %></td>
                       <td> <%= PatientRecords1.getCholestrolLevel() %>" </a></td>
                       <td> <%= PatientRecords1.getRbcCount()  %></td>
                        <td><%= PatientRecords1.getWbcCount() %></td>
                        <td><%= PatientRecords1.getPlateletCount() %></td>
                        <td><%= PatientRecords1.getPressureLevel() %></td>
                       <td> <%= PatientRecords1.getThyroidLevel() %>" </a></td>
                       <td> <%= PatientRecords1.getUpdatePatientRec()  %></td>
                        <td>
